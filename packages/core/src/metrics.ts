...
export const METRICS = [
  {
    ...
    label: "Novelty",
    weight: 0.14,
    desc: "How genuinely new is the capability vs. a repackaging of existing ideas?",
  },
  {
    key: "utility",
    label: "Utility",
    weight: 0.16,
    desc: "How useful in real day-to-day work, not in a demo?",
  },
  {
    key: "deltaVsBaseline",
    label: "Δ vs. Baseline",
    weight: 0.16,
    desc: "How much better than a capable vanilla agent doing it unaided?",
  },
  {
    key: "easeOfAdoption",
    label: "Ease of Adoption",
    weight: 0.1,
    desc: "How cheap to set up and integrate (higher = easier)?",
  },
  {
    key: "maturity",
    label: "Maturity",
    weight: 0.08,
    desc: "Stability, docs, tests, release cadence.",
  },
  {
    key: "leanness",
    label: "Leanness",
    weight: 0.1,
    desc: "How few moving parts it adds (higher = less complexity introduced).",
  },
  {
    key: "traction",
    label: "Traction",
    weight: 0.07,
    desc: "Real adoption momentum — stars velocity, usage, citations.",
  },
  {
    key: "composability",
    label: "Composability",
    weight: 0.07,
    desc: "Plays well alongside your existing tools and workflow.",
  },
  {
    key: "longevity",
    label: "Longevity",
    weight: 0.07,
    desc: "Will it still matter in 6–12 months, or will the base model absorb it?",
  },
  {
    key: "clarity",
    label: "Clarity",
    weight: 0.05,
    desc: "Quality of docs / README / paper — can you actually understand it?",
  },
] as const;
